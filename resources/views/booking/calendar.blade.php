                                ...
                                <div class="modal-content" id="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="modalTable">
                                            <table>
                                                <tr>
                                                    ...
                                                    <td class="right"><input type="text" id="bookTitle" style="width: 100%;"></td>
                                                </tr>
                                                <tr>
                                        ...
                                        <div id="modalfooter" class="d-flex" style="margin: 10px 0 10px 0;">
                                            <span class='close btn btn-danger p-3' style="padding-top: 10px; font-size: 14px; margin-right: 10px;">
                                                <i class="fas fa-window-close"></i> Close
                                            </span>
                                            <span id="deleteBook" class='deleteSpan btn btn-danger p-2' style="padding-top: 8px;"><i class="fa fa-trash"></i></span>
                                            <span id="editBook" class='editSpan btn btn-primary ml-auto p-3' style="padding-top: 8px;"><i class="fas fa-edit"></i> Save</span>
                                            <span id="createBook" class='btn btn-primary ml-auto p-3' style="padding-top: 8px;"><i class="fas fa-pencil-alt"></i> Create</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            var calendar = $('#calendar').fullCalendar({
                ...
                eventResize: function (event) {
                    if (event.user_id == '{{$user->id}}') {
                        var start_time = moment(event.start, 'YYYY-MM-DD HH:mm').format('YYYY-MM-DD HH:mm');
                        var end_time = moment(event.end, 'YYYY-MM-DD HH:mm').format('YYYY-MM-DD HH:mm');
